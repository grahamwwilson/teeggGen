...
C      GOTO (10,20,30),NXTPAR

      print *,'HELLO from TEEGGX '
...
* The following config files are the ones that I have playwed with 
* YMMV - Graham.
* Current compilation script makes a symbolic link to one of them 
* with filename teegg-configfile.f
C      include 'egamma-config.f'
C      include 'egammasoft-config.f'
C      include 'egammahard-config.f'      
C      include 'etron-config.f'
C      include 'etronOPAL-config.f'
C      include 'gamma-config.f'

      include 'teegg-configfile.f'
